...
DataCrazy segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **DataCrazy** | BR | omnichannel CRM platform API (data provider) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [datacrazy@mcp.ai](mailto:datacrazy@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
